...
public abstract class SimilarityMatrix<T> {
    ...
    public String getOutput() {
        return getOutput(null, null, null, null);
    }
    
    @SuppressWarnings("unchecked")
    public <U> String getOutput(Collection<Object> filterFirstDimension, Collection<Object> filterSecondDimension, MatchingAdapter<T> dimensionAdapter, MatchingAdapter<U> labelAdapter) {
        String output = "";
        ...
        if(filterFirstDimension!=null) {
            ...
            while(it.hasNext()) {
                ...
                if(dimensionAdapter!=null) {
                    dim = dimensionAdapter.getLabel(current);
                }
                Object lbl = null;
                if(labelAdapter!=null) {
                    Object label = getLabel(current);
                    lbl = labelAdapter.getLabel((U)label);
                }
                
                if(!filterFirstDimension.contains(dim) && !filterFirstDimension.contains(lbl)) {
                    it.remove();
                }
            }
        ...
        if(filterSecondDimension!=null) {
            ...
            while(it.hasNext()) {
                ...
                if(!filterSecondDimension.contains(dim) && !filterSecondDimension.contains(lbl)) {
                    it.remove();
                }
            }
    ...
    public String getOutput2(Collection<Object> filterFirstDimension, Collection<Object> filterSecondDimension, MatchingAdapter<T> dimensionAdapter, MatchingAdapter<T> dimensionToLabelAdapter) {
        String output = "";
        ...
        if(filterFirstDimension!=null) {
            ...
            while(it.hasNext()) {
                ...
                if(!filterFirstDimension.contains(dim)) {
                    it.remove();
                }
            }
        ...
        if(filterSecondDimension!=null) {
            ...
            while(it.hasNext()) {
                ...
                if(!filterSecondDimension.contains(dim)) {
                    it.remove();
                }
            }
        ...
        int max = 0;
        for (T value : firstDim) {
            Object lbl = dimensionToLabelAdapter.getLabel(value);
            if(lbl!=null) {
                max = Math.max(lbl.toString().length(), max);
            }
        }
        ...
        for (T value : secondDim) {
            Object lbl = dimensionToLabelAdapter.getLabel(value);
            output += padLeft(lbl.toString(), columnWidths.get(i++)) + " | ";
        }
        output += "\n";
        output += padLeft("", columnWidths.get(0)) + " | ";
        output += padLeft("", columnWidths.get(1)) + " | ";
        ...
        for (T value : firstDim) {
            ...
            Object lbl = dimensionToLabelAdapter.getLabel(value);
            output += padRight(lbl+"", columnWidths.get(0)) + " | ";
            colIdx=1;
