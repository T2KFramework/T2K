 ...
 * @author domi
 */
public class TableTitleAdapter extends MatchingAdapter<Table>{
    ...
    public Object getTokens(Table instance) {
        ...
        pageTitle.addAll(Arrays.asList(instance.getTableTitle().split("\\s")));
        return StopWordRemover.removeStopWords(pageTitle);
    }
