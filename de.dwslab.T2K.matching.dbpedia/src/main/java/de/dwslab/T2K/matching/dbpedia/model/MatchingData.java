...
import de.dwslab.T2K.matching.dbpedia.algorithm.PropertyMatchingTask;
...
public class MatchingData {
    ...
    private List<String> dbpediaFunctionalProperties;

    public Collection<String> getDbpediaFunctionalProperties() {
        if (dbpediaFunctionalProperties == null) {
            dbpediaFunctionalProperties = new ArrayList<>();
            dbpediaFunctionalProperties.add("http://dbpedia.org/ontology/restingDate");
            dbpediaFunctionalProperties.add("http://dbpedia.org/ontology/retirementDate");
            dbpediaFunctionalProperties.add("http://dbpedia.org/ontology/zipCode");
            dbpediaFunctionalProperties.add("http://dbpedia.org/ontology/birthDate");
            dbpediaFunctionalProperties.add("http://dbpedia.org/ontology/birthYear");
            dbpediaFunctionalProperties.add("http://dbpedia.org/ontology/deathDate");
            dbpediaFunctionalProperties.add("http://dbpedia.org/ontology/deathYear");
            dbpediaFunctionalProperties.add("http://dbpedia.org/ontology/height");
            dbpediaFunctionalProperties.add("http://dbpedia.org/ontology/length");
            dbpediaFunctionalProperties.add("http://dbpedia.org/ontology/latestReleaseDate");
            dbpediaFunctionalProperties.add("http://dbpedia.org/ontology/netIncome");
            dbpediaFunctionalProperties.add("http://dbpedia.org/ontology/operatingIncome");
            //the populaton of several years can be mentioned
            //dbpediaFunctionalProperties.add("http://dbpedia.org/ontology/populationTotal");
            dbpediaFunctionalProperties.add("http://dbpedia.org/ontology/width");
            dbpediaFunctionalProperties.add("http://dbpedia.org/ontology/weight");
        }
        return dbpediaFunctionalProperties;
    }

    public void setDbpediaFunctionalProperties(List dbpediaFunctionalProperties) {
        this.dbpediaFunctionalProperties = dbpediaFunctionalProperties;
    }
    ...
    public MatchingData shallowCopy() {
        ...
        d.setDbpediaFunctionalProperties(dbpediaFunctionalProperties);
        d.setFrequencies(frequencies);
        return d;
    }

    @SuppressWarnings("unchecked")
    public void loadKG(String dbpediaDirectory, MatchingParameters params) {
...
//        String filePath = "/home/dritze/WTMatching/NEpropertyRanges.txt";
//        Collection<String[]> corres = CSVUtils.readCSV(filePath, "\t");
//        for(String[] s : corres) {
//            List<String> ranges = new ArrayList<>();
//            ranges.add(s[1].replace("http://dbpedia.org/ontology/", ""));
//            NEPropertyRanges.put(s[0],ranges);
//        }
...
//                    + "\t" + countSingleAmount + "\t" + countMultipleAmount + "\n");
    ...
    public void initializeAbstracts() {
        try {
            ...
            if (getDictionaryMap().isEmpty()) {
                ...
                String filePath = "/home/dritze/outputDicLowmaxDF";
                Collection<String[]> corres = CSVUtils.readCSV(filePath, "\t");
            ...
            if (getOverallTermMap().isEmpty()) {
                ...
                String vectorsPath = "/home/dritze/outputVectorMaxDF";
    ...
    public void initializeClassDocuments() {
        try {
            if (getClassDocuments().isEmpty()) {
                BufferedReader read = new BufferedReader(new FileReader(new File("/home/dritze/classDocuments/termCountPerClass.txt")));
                String line = read.readLine();
                while (line != null) {
            ...
            if (getDocumentClassTermCount().isEmpty()) {
                String filePath = "/home/dritze/classDocuments/docFreq.txt";
                Collection<String[]> corres = CSVUtils.readCSV(filePath, "\t");
    ...
    public Table loadWebTable(String webtablePath, MatchingParameters params, WebtableToDBpediaMatchingProcess.tableType type, boolean... noSF) {
        TableReader r = new TableReader();
        r.setUseUnitDetection(params.isUseUnitDetection());
...
//            }
    ...
    public Table loadWebTable(String webtablePath, Timer tim, MatchingParameters params, WebtableToDBpediaMatchingProcess.tableType type, boolean... noSF) {
