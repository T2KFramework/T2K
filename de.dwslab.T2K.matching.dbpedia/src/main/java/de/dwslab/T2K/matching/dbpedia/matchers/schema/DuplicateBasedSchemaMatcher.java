...
public class DuplicateBasedSchemaMatcher extends PartialMatcher<TableColumn> {
    ...
    private Collection<Table> otherTabs;
...
//                if(properties.get(c1, c2) > 0.0) {
//                    System.out.println(c1 + " ---- " + c2 + " --- " + properties.get(c1, c2));
//                }
//            }
//        }
     ...
     */
    public Collection<Table> getOtherTabs() {
        return otherTabs;
    }
     ...
     */
    public void setOtherTabs(Collection<Table> otherTabs) {
