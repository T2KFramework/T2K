...
public class IterativeComponent extends WebtableToDBpediaMatchingComponent {
    ...
    public static final Parameter PAR_PROP_LABELS_WEIGHT = new Parameter("Iterative.Property.Labels_weight", 0.0);
    public static final Parameter PAR_PROP_EQUIVALENCES_WEIGHT = new Parameter("Iterative.Property.Equivalences_weight", 0.0);
    public static final Parameter PAR_PROP_VALUES_WEIGHT = new Parameter("Iterative.Property.Values_weight", 1.0);
    ...
    static {
        ...
        params.add(PAR_PROP_LABELS_WEIGHT);
...
//                } else {
                    if(wLbl>0.0) {
                        ...
                        combinedValues = Matcher.addSimilarity(propertySimilarity, lbl);
//                    }
...
//        }        
        ...
        System.out.println(
                "final: " + propertySimilarity.getOutput2(null, null, new TableColumnMatchingAdapter(), new TableColumnTableLabelAdapter()));
